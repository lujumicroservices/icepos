...
/// Sube imágenes al bucket Supabase `product-images` (ver migración 014).
class ProductImageService {
  ...
  static Future<String?> uploadProductImage({
    ...
    try {
      ...
      final path = 'products/$productId/${_uuid.v4()}.$ext';
      ...
      // ignore: avoid_print
      print('ProductImageService.uploadProductImage: $e\n$st');
      return null;
    }
  }
