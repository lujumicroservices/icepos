...
-- Después: en el dispositivo con el menú cargado, usa "Enviar datos a la nube" para subir de nuevo.

-- Orden por dependencias (hijos antes que padres). RESTART IDENTITY resetea los serials.
